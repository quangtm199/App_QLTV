 ...
 */
public class GDThemBanDoc1 extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        btndanhsachbandoc.setText("Danh Saacsh Bạn Đọc");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
          ...
          if ((a1&&a2&&a3&&a4)==false){JOptionPane.showMessageDialog(null, "nhap sai dinh dang cua TK TKxxx");
            ...
            Logger.getLogger(GDThemBanDoc1.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 private void reset(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GDThemBanDoc1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
